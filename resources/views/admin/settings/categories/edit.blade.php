@extends('layouts.admin', ['header' => "Обновление категории: $category->name"])
                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="v-pills-ru" role="tabpanel"
                            ...
                            <div class="form-group">
                                ...
                                <input id="name_ru" name="name_ru" class="form-control" value="{{ old('name_ru', $category->translate('ru')->name) }}">
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade show" id="v-pills-en" role="tabpanel"
                            ...
                            <input id="name_en" name="name_en" class="form-control" value="{{ old('name_en', $category->translate('en')->name) }}">
                        </div>
